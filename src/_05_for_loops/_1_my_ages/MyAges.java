...
public class MyAges {
	public static void main(String[] args) {
		...
		/**
		 * This program will use loops to print all the ages you have been alive, from
		 * zero up to your current age.
		 **/

		// Make an int variable called age, to track how many times the loop has
		// repeated
		...
		/***
		 * Now you are going to do the same thing, but this time use a for loop. Notice
		 * how most of the information is the same, it is just written in a different
		 * way.
		 **/
